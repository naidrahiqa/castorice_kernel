...
func (tp *ToolboxPage) checkLatestRelease() {
	...
	go func() {
		...
		resp, err := client.Get("https://api.github.com/repos/naidrahiqa/epitaph_rescue/releases/latest")
		...
		fyne.Do(func() {
			...
			if resp.StatusCode != http.StatusOK {
				...
				tp.richChangelog.SetText("Repository GitHub naidrahiqa/epitaph_resque belum memiliki rilis stable.")
				return
			}
